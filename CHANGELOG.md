...
- Ports are classified as primary or internal. Debug inspectors and ephemeral-range sockets fold behind a per-project "more" row, with a setting to always show them.
